...
`ash
git clone [https://github.com/MalharSadhu/MalharIQ.git](https://github.com/MalharSadhu/MalharIQ.git)
cd MalharIQ
`
...
- Micro-datasets (< 30 samples) crash standard train/validation/test holdout splits.
- MalharIQ detects sparse datasets and bootstraps statistically consistent records up to 100 samples, preserving numerical covariance, Gaussian variance, and categorical distribution frequencies.
