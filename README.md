...
3. Strict 70 / 15 / 15 Partitioning Architecture:
   ...
   - 70% training set (fitting candidate models)
   - 15% validation set (hyperparameter tuning and leaderboard tournament ranking)
   - 15% test set (untouched holdout partition for final empirical reporting)
n4. Multi-Algorithm Tournaments:
   ...
   - Classification: Random Forest, RGBoost, Logistic Regression, Support Vector Machines (SVM), KNN, Deep MLP, Soft Voting Ensembles, and Stacking Classifiers.
